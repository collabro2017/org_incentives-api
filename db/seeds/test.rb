...
tenant = Tenant.create!({ name: "Fake Company Group", id: "344437fa-6bbc-4744-9aa7-633e2ea61c8f" })

tenant.feature = Feature.new(exercise: false)
tenant.feature.save!

entity_1 = tenant.entities.create!(name: "Fake Company Norway", identification: Faker::Company.norwegian_organisation_number, countryCode: "no", tenant_id: tenant.id)
...
colin = tenant.employees.create!(firstName: "Colin Patric", lastName: "Ntenga", email: "colinp.ntenga+auth@gmail.com", entity_id: entity_1.id, residence: "tz", account_id: "5a31425886da0c1d55479bcd", tenant_id: tenant.id)
aleksander = tenant.employees.create!(firstName: "Aleksander", lastName: "Hindenes", email: "aleksander.hindenes+auth0@gmail.com", entity_id: entity_1.id, residence: "no", account_id: "5a2e91a886da0c1d55470a76", tenant_id: tenant.id)
...
sub_program_template = IncentiveSubProgramTemplate.create!(grantDate: start_date, expiryDate: end_date, incentive_sub_program_id: sub_program.id)

default_vested_date_1 = "16.02.2017"
default_vested_date_2 = "16.02.2018"
default_vested_date_3 = "16.02.2019"
default_vested_date_4 = "16.02.2020"
...
sub_program_template.vesting_event_templates.create!(quantityPercentage: default_quantity_percentage_1, strike: default_strike_1, vestedDate: default_vested_date_1)
sub_program_template.vesting_event_templates.create!(quantityPercentage: default_quantity_percentage_2, strike: default_strike_2, vestedDate: default_vested_date_2)
sub_program_template.vesting_event_templates.create!(quantityPercentage: default_quantity_percentage_3, strike: default_strike_3, vestedDate: default_vested_date_3)
sub_program_template.vesting_event_templates.create!(quantityPercentage: default_quantity_percentage_4, strike: default_strike_4, vestedDate: default_vested_date_4)

aleksander_quantity = 16000000
award_aleksander = sub_program.awards.create!(grantDate: start_date, expiryDate: end_date, quantity: aleksander_quantity, employee_id: aleksander.id)
award_aleksander.vesting_events.create!(vestedDate: default_vested_date_1, strike: default_strike_1, quantity: aleksander_quantity * default_quantity_percentage_1)
award_aleksander.vesting_events.create!(vestedDate: default_vested_date_2, strike: default_strike_2, quantity: aleksander_quantity * default_quantity_percentage_2)
award_aleksander.vesting_events.create!(vestedDate: default_vested_date_3, strike: default_strike_3, quantity: aleksander_quantity * default_quantity_percentage_3)
award_aleksander.vesting_events.create!(vestedDate: default_vested_date_4, strike: default_strike_4, quantity: aleksander_quantity * default_quantity_percentage_4)

colin_quantity = 16000000
award_aleksander = sub_program.awards.create!(grantDate: start_date, expiryDate: end_date, quantity: colin_quantity, employee_id: colin.id)
award_aleksander.vesting_events.create!(vestedDate: default_vested_date_1, strike: default_strike_1, quantity: colin_quantity * default_quantity_percentage_1)
award_aleksander.vesting_events.create!(vestedDate: default_vested_date_2, strike: default_strike_2, quantity: colin_quantity * default_quantity_percentage_2)
award_aleksander.vesting_events.create!(vestedDate: default_vested_date_3, strike: default_strike_3, quantity: colin_quantity * default_quantity_percentage_3)
award_aleksander.vesting_events.create!(vestedDate: default_vested_date_4, strike: default_strike_4, quantity: colin_quantity * default_quantity_percentage_4)
