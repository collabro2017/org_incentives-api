...
mapped = countries.map {|c|
  print c
  {countryName: c[:text], code: c[:value]}
}
...
Config.create!({ id: "71184113-81aa-47c7-b435-d04896853c1d", texts: {} })

tenant = Tenant.create!({ name: "Fake Company", id: "344437fa-6bbc-4744-9aa7-633e2ea61c8f" })

tenant.feature = Feature.new(exercise: true)
tenant.feature.save!
tenant.stock_prices.create!(price: '2.5', date: Date.new, manual: false)
tenant.exercise_windows.create!(startTime: Date.today, endTime: Date.today + 14)

entity_1 = tenant.entities.create!(id: "284f7628-9fa5-426e-b3ea-954a577c814d", name: "Fake Company Norway", identification: Faker::Company.norwegian_organisation_number, countryCode: "no", tenant_id: tenant.id)
entity_2 = tenant.entities.create!(name: "Fake Company Spain", identification: Faker::Company.norwegian_organisation_number, countryCode: "es", tenant_id: tenant.id)
employee = tenant.employees.create!(firstName: "Aleksander", lastName: "Hindenes", email: "aleksander.hindenes+auth0@gmail.com", entity_id: entity_1.id, residence: "no", account_id: "5a2e91a886da0c1d55470a76", tenant_id: tenant.id)

start_date = "01.01.2016"
end_date = "02.04.2020"

p_2016 = tenant.incentive_programs.create!(name: "Program 2016", startDate: start_date, endDate: end_date, capacity: 0)
sub_program = p_2016.incentive_sub_programs.create(name: "Excecutive Option Program", instrumentTypeId: "option", settlementTypeId: "equity")

sub_program_template = IncentiveSubProgramTemplate.create!(incentive_sub_program_id: sub_program.id)

default_vested_date_1 = "01.01.2017"
default_vested_date_2 = "01.01.2018"
default_vested_date_3 = "01.01.2019"
default_vested_date_4 = "01.01.2020"

default_strike_1 = 1
default_strike_2 = 1.15
default_strike_3 = 1.25
default_strike_4 = 1.30

default_quantity_percentage_1 = 0.27
default_quantity_percentage_2 = 0.27
default_quantity_percentage_3 = 0.27
default_quantity_percentage_4 = 0.19

sub_program_template.vesting_event_templates.create!(quantityPercentage: default_quantity_percentage_1, strike: default_strike_1, vestedDate: default_vested_date_1, grant_date: start_date, expiry_date: end_date)
sub_program_template.vesting_event_templates.create!(quantityPercentage: default_quantity_percentage_2, strike: default_strike_2, vestedDate: default_vested_date_2, grant_date: start_date, expiry_date: end_date)
sub_program_template.vesting_event_templates.create!(quantityPercentage: default_quantity_percentage_3, strike: default_strike_3, vestedDate: default_vested_date_3, grant_date: start_date, expiry_date: end_date)
sub_program_template.vesting_event_templates.create!(quantityPercentage: default_quantity_percentage_4, strike: default_strike_4, vestedDate: default_vested_date_4, grant_date: start_date, expiry_date: end_date)

quantity = 16000000
exercised_quantity = 1000
award = sub_program.awards.create!(quantity: quantity, employee_id: employee.id)
ve1 = award.vesting_events.create!(grant_date: start_date, expiry_date: end_date, vestedDate: default_vested_date_1, strike: default_strike_1, quantity: (quantity * default_quantity_percentage_1) - exercised_quantity, exercisedQuantity: exercised_quantity)
ve1.transactions.create!(grant_date: start_date, expiry_date: end_date, vested_date: default_vested_date_1, strike: default_strike_1, quantity: (quantity * default_quantity_percentage_1) - exercised_quantity)
ve2 = award.vesting_events.create!(grant_date: start_date, expiry_date: end_date, vestedDate: default_vested_date_2, strike: default_strike_2, quantity: (quantity * default_quantity_percentage_2) - exercised_quantity, exercisedQuantity: exercised_quantity)
ve2.transactions.create!(grant_date: start_date, expiry_date: end_date, vested_date: default_vested_date_2, strike: default_strike_2, quantity: (quantity * default_quantity_percentage_2) - exercised_quantity)
ve3 = award.vesting_events.create!(grant_date: start_date, expiry_date: end_date, vestedDate: default_vested_date_3, strike: default_strike_3, quantity: (quantity * default_quantity_percentage_3) - exercised_quantity, exercisedQuantity: exercised_quantity)
ve3.transactions.create!(grant_date: start_date, expiry_date: end_date, vested_date: default_vested_date_3, strike: default_strike_3, quantity: (quantity * default_quantity_percentage_3) - exercised_quantity)
ve4 = award.vesting_events.create!(grant_date: start_date, expiry_date: end_date, vestedDate: default_vested_date_4, strike: default_strike_4, quantity: (quantity * default_quantity_percentage_4) - exercised_quantity, exercisedQuantity: exercised_quantity)
ve4.transactions.create!(grant_date: start_date, expiry_date: end_date, vested_date: default_vested_date_4, strike: default_strike_4, quantity: (quantity * default_quantity_percentage_4) - exercised_quantity)
